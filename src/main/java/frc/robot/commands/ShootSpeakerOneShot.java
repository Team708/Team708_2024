...
public class ShootSpeakerOneShot extends ParallelDeadlineGroup {   //ParallelRaceGroup
  /** Creates a new ShootSpeakerPCG. */
  public ShootSpeakerOneShot(Drivetrain m_drive, Intake m_intake, Feeder m_feeder, PivotArm m_pivotArm, Shooter m_shooter) {
    // Add the deadline command in the super() call. Add other commands using
    // addCommands().
    // super(new EnableAutoTargetSpeaker(m_drive));
    // addCommands(new FooCommand(), new BarCommand());
    super(new FeederOneShot(m_feeder));

...
import frc.robot.utilities.logging.LogValue.LoggableType;
import frc.robot.utilities.logging.LoggingThread.Writer;
...
public class Logger {
    ...
    private static boolean ntDebuggingEnabled = !GlobalConstants.competitionMode;

...
public final class Constants {
   ...
   */
    ...
    public static final double kIntakeRPM = 4100; //5000;
    ...
    public static final double kIntake_I = 0; //0.000001; 
    public static final double kIntake_D = 0; //0.0004;
    public static final double kIntake_FF = 0.01; //0.0;
  ...
  public static final class FeederConstants {
    ...
    public static final double kFeederLoadRPM   = 4200; //5000;
    public static final double kFeederShootRPM  = 4200; //5000;  //In the event the load and shoot RPMs are the same, remove this

    
    //PID values
    //make sure the PID values get tuned
    public static final double kFeederStage1Motor_P = 0.00001; //0.00015;
    public static final double kFeederStage1Motor_I = 0.0; 
    public static final double kFeederStage1Motor_D = 0.0;
    public static final double kFeederStage1Motor_FF = 0.00021; //0.0;
  ...
  public static final class ShooterConstants {    
    ...
    //speed constants
    public static final double kShooterSpeakerRPM = 4000; //6000;
    ...
    public static final double kShooterTop_I = 0; //0.000001; 
    public static final double kShooterTop_D = 0; //0.0004;
    ...
    public static final double kShooterAmp_I = 0; // 0.000001; 
    public static final double kShooterAmp_D = 0; // 0.0004;
    public static final double kShooterAmp_FF = 0.003;
